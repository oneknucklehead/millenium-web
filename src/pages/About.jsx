...
const About = () => {
  return (
    <>
      <Helmet>
        <title>Millenium Global India | About Us</title>
        <meta
          name="description"
          content="Learn more about Millenium Global, our mission, vision, and the values driving our services."
        />
        <meta property="og:title" content="Millenium Global India | About Us" />
        <meta
        ...
        <Container className="px-4 py-12 ">
          ...
          >
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
              ...
              professionals. What started as a vision to serve the growing
              demands of the Indian Telecom Sector has today evolved into a
              Pan-India powerhouse for Telecom Infrastructure Services,
              Corporate Employee Transport Solutions, Logistics Solutions, HR
              Recruitment, Facility Management, and Event Management Services.
            </p>

            <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
              With a commitment to client-centric innovation, 100% compliance,
              and green mobility, we deliver tailored, scalable solutions
              powered by an outsourced business model and cutting-edge
              technology.
            </p>
            ...
            <div className="border border-black rounded-xl p-6 md:p-10 grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <p className="text-gray-700 text-sm md:text-base mb-6 leading-relaxed">
                  Millenium Global delivers a powerful suite of six core
                  services, built to meet the needs of enterprise clients across
                  India—from Delhi NCR to Mumbai, Kolkata, Chennai, Guwahati,
                  and beyond. Our model is outsourced, scalable, tech-powered,
          ...
          <p className="max-w-5xl mx-auto text-center text-gray-600 text-sm md:text-base my-12">
            ...
            advanced automation, and a relentless focus on quality, we’re
            building the infrastructure that keeps India moving.
          </p>
