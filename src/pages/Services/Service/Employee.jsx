...
export default function Employee() {
  ...
  return (
    <>
      <Helmet>
        <title>Millenium Global India | Employee Transport Services</title>
        <meta
          name="description"
          content="Millenium Global provides tailored employee solutions to enhance productivity and workplace satisfaction."
        />
        <meta
          property="og:title"
          content="Millenium Global India | Employee Transport Services"
        />
        <meta
          property="og:description"
          content="Comprehensive event management solutions tailored for your needs."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://milleniumglobal.in/services/events"
        />
      ...
      <section className="pt-[80px]">
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-12">
            ...
            >
              <p>
                At Millenium Global, we revolutionize corporate mobility with
                our end-to-end Employee Transportation Solutions. Our
                tech-driven approach ensures a safe, reliable, and comfortable
                commute for your workforce, enhancing productivity and peace of
                mind. As a trusted partner for businesses in Gurgaon, Chennai,
                Mumbai, and other major hubs, we deliver seamless logistics,
                professional fleet management, and tailored services that
                perfectly align with your operational needs.
              </p>
              <p>
                Millenium Global delivers end-to-end corporate transportation
                solutions for enterprises, BPOs, telecom projects, and
                industrial hubs across Delhi NCR, Mumbai, Kolkata, Chennai, and
                Pan-India. From daily employee commute to dedicated project
                fleets, we combine technology, safety, and sustainability to
                ensure on-time, compliant, and comfortable travel for thousands
                of passengers daily.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-12">
            ...
            >
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
                ...
                requirements. We deploy a modern fleet of vehicles, including
                our eco-friendly EVs, alongside our professionally trained and
                vetted drivers, ensuring a high standard of service from day
                one.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-12">
            ...
            >
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
                ...
                like Delhi NCR, Mumbai, Kolkata, and Guwahati, we provide
                scalable corporate mobility solutions wherever your business is
                located. Our top priority is safety, with every vehicle and
                driver adhering to strict safety protocols, regular audits, and
                all regulatory compliance standards.
              </p>
            </motion.div>
          </div>
