...
export default function Logistics() {
  ...
  return (
    <>
      <Helmet>
        <title>Millenium Global India | 3PL & Logistics Services</title>
        <meta
          name="description"
          content="Reliable logistics services including transport, supply chain, and distribution solutions to keep your business moving."
        />
        <meta
          property="og:title"
          content="Millenium Global India | 3PL & Logistics Services"
        />
        <meta
          property="og:description"
          content="Streamlined logistics services tailored for efficiency."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://milleniumglobal.in/services/logistics"
        />
        <link
          rel="canonical"
      ...
      <section className="pt-[80px]">
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-12">
            ...
            >
              <p>
                Millenium Global offers comprehensive Third-Party Logistics
                (3PL) services, specializing in the complex demands of the
                telecom industry. From forward and reverse logistics for
                partners like Samsung and Jio Infocom to end-to-end supply chain
                management, our scalable solutions optimize every step of the
                process. With a strong presence in regions like Assam, North
                East India, and Kolkata, we ensure timely, secure, and
                cost-effective delivery of goods, empowering your business to
                focus on core operations. From first-mile and last-mile
                deliveries to reverse logistics, warehousing, and fleet
                management, we handle every stage of the supply chain with
                speed, compliance, and care.
              </p>
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-12">
            ...
            >
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
                We design custom logistics solutions to meet the specialized
                needs of telecom operators, OEMs, corporates, and industrial
                hubs.From first-mile and last-mile deliveries to reverse
                logistics, warehousing, and fleet management, we handle every
                stage of the supply chain with speed, compliance, and care.
              </p>
            </motion.div>
          </div>
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-12">
            ...
            >
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
                With years of hands-on experience in managing complex,
                high-volume logistics operations, Millenium Global has supported
                nationwide telecom rollouts, corporate relocations, and critical
                event deployments. Our track record reflects zero-compromise
                safety standards, timely deliveries, and a client-first approach
                that has earned the trust of industry leaders across multiple
                sectors.
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-sm md:text-base mb-4">
              ...
              <span className="font-semibold">Millenium Global’s</span>{" "}
              logistics division delivers speed, security, and scalability you
              can count on.
            </p>

            <p className="max-w-2xl mx-auto text-sm md:text-base mb-6">
              Request a logistics proposal or schedule a supply chain
              consultation today.
            </p>
