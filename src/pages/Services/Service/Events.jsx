...
export default function Events() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Millenium Global India | Events & MICE Management Services
        </title>
        <meta
          name="description"
          content="Millenium Global offers end-to-end event management services, from planning to execution, ensuring seamless and impactful experiences."
        />
        <meta
          property="og:title"
          content="Millenium Global India | Events & MICE Management Services"
        />
        <meta
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-12">
            ...
            >
              ...
              <p>
                Our approach is 360° and turnkey: strategy, creative design,
                venue sourcing, travel & accommodation, artist management, event
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-sm md:text-base mb-4">
              Whether it’s a high-profile product launch, a team-building
              getaway, or a global conference,
