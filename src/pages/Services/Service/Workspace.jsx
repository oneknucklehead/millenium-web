...
export default function Workspace() {
  ...
  return (
    <>
      <Helmet>
        <title>Millenium Global India | Workspace & HR Solutions</title>
        <meta
          name="description"
          content="Flexible workspace solutions designed to enhance productivity, collaboration, and innovation."
        />
        <meta
          property="og:title"
          content="Millenium Global India |  Workspace & HR Solutions"
        />
        <meta
          property="og:description"
          content="Modern workspace solutions for businesses of all sizes."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://milleniumglobal.in/services/workspace"
        />
        <link
          rel="canonical"
          href="https://milleniumglobal.in/services/workspace"
        />
        ...
        <script type="application/ld+json">{`
        {
          ...
          "@type": "Service",
          "serviceType": "Workspace & HR Solutions",
          "provider": {
            "@type": "Organization",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-12">
            ...
            >
              ...
              <p>
                ...
                ensure productivity, comfort, and brand alignment at every
                stage. Our HR division extends this expertise by sourcing,
                training, and placing top talent to keep your business
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-12">
            ...
            >
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed">
                ...
                workforce operations. We deliver to corporate offices,
                industrial hubs, government facilities, IT parks, hospitals,
                schools, banks, malls, and events with tailored approaches for
                each sector
              </p>
            </motion.div>
          </div>
