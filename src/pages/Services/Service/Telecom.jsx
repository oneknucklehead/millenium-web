...
export default function Telecom() {
  ...
  return (
    <>
      <Helmet>
        <title>Millenium Global India | Telecom Solutions</title>
        <meta
          name="description"
          content="Cutting-edge telecom solutions that connect businesses with seamless communication and networking services."
        />
        <meta
          property="og:title"
          content="Millenium Global India | Telecom Solutions"
        />
        <meta
          property="og:description"
          content="Telecom and networking solutions to keep your business connected."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://milleniumglobal.in/services/telecom"
        />
        <link
          rel="canonical"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-12">
            ...
            >
              <p>
                ...
                telecom solutions designed to build, optimize, and maintain
                robust network infrastructures. Millenium Global delivers
                full-spectrum telecom solutions, from planning and site
                acquisition to 4G/5G rollout, RF optimization.
              </p>
              <p>
                From cutting-edge 4G/5G deployments in Delhi NCR and Mumbai to
                critical network management across Kolkata and Chennai, we are
                the trusted partner for leading telecom operators and ISPs
                seeking efficiency, scalability, and technical excellence
                nationwide. We’ve executed thousands of rollout and optimization
                packages for leading operators and OEM partners, demonstrating
                deep field capability and robust logistics support.
              </p>
            </motion.div>
          </div>
        </Container>
        ...
        <Container className="px-4 md:px-10 py-12 overflow-hidden">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-sm md:text-base mb-4">
              ...
              the field expertise, regional reach and operational rigor to
            ...
            <p className="max-w-2xl mx-auto text-sm md:text-base mb-6">
              ...
              Delivery team to discuss scope, timelines, and a tailored
              commercial plan.
            </p>
